    <div class="image-title-centered">
        <img id="event-banner"  class="event-banner" src="{{ asset($event->img_path) }}" alt="Image not found" onerror="this.onerror=null;this.src='{{ asset('storage/preview/preview-image.jpg') }}';" />
